...
class ExtrapolationPlots:
    ...
    def __init__(self, model, model_list, fitEnv, fit_result, switches):
        ...
        self.shapes = {'m400':'h', 'm350':'p', 'm310':'s', 'm220':'^', 'm180':'d', 'm130':'o', 'm135':'*'}
        self.labels = {
            'a15m400':'', 'a15m350':'', 'a15m310':'a15', 'a15m220':'','a15m135XL':'',
            'a12m400':'', 'a12m350':'', 'a12m310':'a12', 'a12m220':'', 'a12m130':'',
            'a12m220L':'', 'a12m220S':'','a15m310L':'','a12m180L':'', 'a12m220ms':'',
        ...
        self.dx_cont = {
            ...
            'a12m220L' :-0.0037,'a12m220S':-0.0012,'a15m310L':-0.0025, 'a12m180L':0, 'a12m220ms':0.0012,
        }
