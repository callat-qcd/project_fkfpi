...
data_loader.save_plots(fig, output_filename=collection_name+'/histogram_delta_su2')


fig = model_average.plot_comparison(other_results=other_results, param='FK/Fpi_pm')
data_loader.save_plots(fig, output_filename=collection_name+'/comparison_fits')

fig = model_average.plot_comparison(other_results=other_results, param='delta_su2')
data_loader.save_plots(fig, output_filename=collection_name+'/comparison_delta_su2')


fig = model_average.plot_fits('a')
data_loader.save_plots(fig, output_filename=collection_name+'/all_fits_vs_latt_spacing')

fig = model_average.plot_fits('mpi')
data_loader.save_plots(fig, output_filename=collection_name+'/all_fits_vs_mpi')

fig = model_average.plot_fits('volume')
data_loader.save_plots(fig, output_filename=collection_name+'/all_fits_vs_volume')
