// jbdtheta2d0.cc is part of the numerical library jbnumlib
...
/* uses modular symmetry to get faster converging series,
...
double jbdtheta2d0(const double al, const double be, const double ga){
