// testLinf.cc is part of the CHIRON ChPT at two loops program collection
// Copyright (C) 2014 Johan Bijnens, v1.0
// CHIRON is licenced under the GNU GPL version 2 or later,
// see COPYING for details.
// Please respect the Guidelines, see GUIDELINES for details.

// test the Linf class implementations
...
int main(void){
  Linf liset1;
  cout << "A default set if Linf inputs:\n";
  cout << liset1;
  // an example with setting all numerical values and functions with the scale
  // and name
  Linf liset2(0.5e-3,1e-3,2e-3,3e-3,4e-3,5e-3,6e-3,7e-3,8e-3,9e-3,10e-3,11e-3,12e-3,13e-3);
  liset2.setmu(0.9);
  liset2.setname("Set 2");
  cout << "Another simple example:\n";
  cout << liset2;
  // an example setting the name and some individual Linf
  Linf liset3;
  liset3.setlinf(3,6e-3);
  liset3.setlinf(5e-3,4);
  liset3.setname("set 3");
  cout << "The output of some inputs\n";
  cout << liset3;
  // summing some, note the first should complain
  Linf liset4 = liset2+liset3;
  liset2.setmu(0.77);
  Linf liset5 = liset2+liset3;
  liset5.setname("sum");
  cout << liset5;
  Linf liset5b = liset2-liset3;
  liset5b.setname("difference");
  cout << liset5b;
  // multiplying a set with a number from both sides
  Linf liset6 = 2.*liset3;
  Linf liset7 = liset3*2.;
  ...
  cout << "Output for some random Linf:\n"
       << "NOTE: these can (should) differ from the outputs in testLinf.dat\n";
  cout << Linfrandom();
  return 0;
}
