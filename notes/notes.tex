...
As a first test of our fits, André and I have performed the \texttt{ma-taylor} \texttt{xpt-taylor} fits at NLO on each ensemble, where there is only one parameter that needs to be determined ($L_5$). See fig \ref{fig:L5-comparison}.
