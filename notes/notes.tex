...
+\cdots
\end{equation}
{\color{red} (Probably need better names for $A_{2, 2}$, $M_{2, 2, 0}$, etc -- convention make no sense to me.)}
...
{\color{red} (Should the odd numbered terms also disappear?)}
...
{\color{red} (Should these corrections also include terms of the form $am_K$, $am_{ju}$, etc? Does this have an $n=1$ term?)}
...
\end{equation}
a task currently underway in another project.  {\color{red} (Is this right?)}
...
\section{The Weeds}
The actual fit here is being done in lattice units, not physical units, which is possible since the ratio $F_K / F\pi$ is dimensionless.
