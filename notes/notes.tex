...
\begin{equation}
P(D | M_k) = \int \prod_j \text{d} \theta_j \,  P(D | \theta_j, M_k) P(\theta_j | M_k) \, .
\end{equation}
...
\text{Var}[Y] &= \sum_k \sqrt{P(M_k | D)}^T \text{Cov}[Y | M_k] \sqrt{P(M_k | D)} 
...
\foreach \model in {ma, ma-taylor, xpt, xpt-taylor}
{
	\begin{figure}[H]
		\begin{subfigure}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{"./../tmp/exclude_lecs/\model_chained-True_exclude-n2lo".pdf}
		\end{subfigure}
		~
		\begin{subfigure}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{"./../tmp/exclude_lecs/\model_chained-False_exclude-n2lo".pdf}
		\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=\linewidth]{"./../tmp/vol-corrections_ma_chained-True".pdf}
		\caption{\texttt{ma\_nnlo}}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=\linewidth]{"./../tmp/vol-corrections_ma-taylor_chained-True".pdf}
		\caption{\texttt{ma-taylor\_nnlo}}
	\end{subfigure}

	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=\linewidth]{"./../tmp/vol-corrections_xpt_chained-True".pdf}
		\caption{\texttt{xpt\_nnlo}}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=\linewidth]{"./../tmp/vol-corrections_xpt-taylor_chained-True".pdf}
