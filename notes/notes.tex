...
\begin{enumerate}
	...
	\item Choose whether to add no more terms; add the log squared  terms; or add the log-squared terms,  the single log terms, and the semi-NNLO pure sunset term.
\end{enumerate}

In totality, this procedure will generate $4 \times 3 \times 2 \times 2 \times 2 \times 3 = 288$ different models.
