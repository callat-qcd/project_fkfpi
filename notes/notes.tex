...
\begin{tabular}{|l|c|}\hline%
	\bfseries fit & \bfseries logGBF \\ \hline\hline
	\csvreader[head to column names, before reading=\sisetup{table-format=1.3,round-mode=places,round-precision=3}]{"./../results/fit"_"results".csv}{}%
	{\\ \fit & \logGBF}%
	\\\hline
\end{tabular}
