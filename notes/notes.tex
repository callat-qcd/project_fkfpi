...
\end{equation}
That is, they are related to the expectation value for the pseudoscalar to return to the (QCD) vacuum, which occurs by the action of its antiparticle on the state. This particular combination of gamma matrices ensures the antiparticle is a pseudoscalar also.
...
\begin{figure}
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphicsifexists[width=\textwidth]{./../tmp/L5_comparison_ma-taylor.pdf}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphicsifexists[width=\textwidth]{./../tmp/L5_comparison_xpt-taylor.pdf}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphicsifexists[width=\linewidth]{"./../tmp/vol-corrections_ma_chained-True".pdf}
		\caption{\texttt{ma\_nnlo}}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphicsifexists[width=\linewidth]{"./../tmp/vol-corrections_ma-taylor_chained-True".pdf}
		\caption{\texttt{ma-taylor\_nnlo}}
	\end{subfigure}

	\begin{subfigure}[b]{.45\linewidth}
		\includegraphicsifexists[width=\linewidth]{"./../tmp/vol-corrections_xpt_chained-True".pdf}
		\caption{\texttt{xpt\_nnlo}}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphicsifexists[width=\linewidth]{"./../tmp/vol-corrections_xpt-taylor_chained-True".pdf}
...
\begin{figure}
	\includegraphicsifexists[width=0.9\textwidth]{./../tmp/fit_comparison.pdf}
...
\begin{figure}
	\includegraphicsifexists[width=0.9\textwidth]{./../tmp/delta-su2_comparison.pdf}
...
\iffalse
	...
	\begin{table}
		\begin{center}
			...
			\begin{tabular}{l|ll|lll}\toprule%|llllll}\toprule
	...
	\foreach \model in {ma, ma-taylor, xpt, xpt-taylor}
	{
		...
		\foreach \order in {nlo, nnlo}
		{
			\begin{figure}[H]
				...
				\includegraphicsifexists[width=\textwidth, page=3]{"./../tmp/fits/\model"_"\order".pdf}
			\end{figure}
		}
	}
