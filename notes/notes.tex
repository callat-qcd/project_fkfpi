...
For the $\chi$PT fit in particular, we can use the results derived in \cite{Ananthanarayan:2017qmx}. First, let us define
The NNLO $\chi$PT fits can be more succinctly written with the following definitions. Let
\begin{equation}
\begin{aligned}[c]
